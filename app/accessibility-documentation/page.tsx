    ...
    >
      ...
      <DocumentationCard
        ...
        description={
          <ul className="list-disc list-inside space-y-1 text-gray-600 dark:text-gray-300">
            ...
            <li>
              Utiliser du HTML sémantique pour un meilleur support des lecteurs
              d’écran.
            </li>
            <li>
      ...
      <DocumentationCard
        ...
        description={
          <ul className="list-disc list-inside space-y-1 text-gray-600 dark:text-gray-300">
            <li>
              <strong>Déficiences visuelles :</strong> Utilisez un contraste de
              couleur approprié et supportez les lecteurs d&apos;écran.
            </li>
            <li>
            ...
            <li>
              <strong>Déficiences cognitives :</strong> Simplifiez la navigation
              et évitez les animations accablantes.
            </li>
          </ul>
        }
      ...
      <DocumentationCard
        ...
        description={
          <ul className="list-disc list-inside space-y-1 text-gray-600 dark:text-gray-300">
            ...
            <li>
              <strong>Accessibilité au clavier :</strong> Gérez l’ordre de focus
              avec <code>tabindex</code> et évitez les pièges de focus.
            </li>
          </ul>
        }
      ...
      >
        <p className="text-gray-600 dark:text-gray-300">
          ...
          c&apos;est une responsabilité. Commencez à intégrer ces principes dès
          aujourd&apos;hui pour créer des applications plus inclusives.
        </p>
      </motion.footer>
    </motion.div>
  );
